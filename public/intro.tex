...
double y = y0;
\end{verbatim}
The command \verb+\verbatiminput{programs/Square.java}+ allows you to list the file \texttt{Square.java} in the directory programs.
